        ...
        return [
            "<div class='sp-container sp-hidden'>",
                ...
                "<div class='sp-picker-container'>",
                    ...
                    "</div>",
                    "<div class='sp-input-rgb-container'>",
                        "<div class='sp-input-rgb-r-container'><span class='sp-input-rgb-r-label'>R:</span><input class='sp-input-rgb-r' type='text' spellcheck='false'  /></div>",
                        "<div class='sp-input-rgb-g-container'><span class='sp-input-rgb-g-label'>G:</span><input class='sp-input-rgb-g' type='text' spellcheck='false'  /></div>",
                        "<div class='sp-input-rgb-b-container'><span class='sp-input-rgb-b-label'>B:</span><input class='sp-input-rgb-b' type='text' spellcheck='false'  /></div>",
                    "</div>",
