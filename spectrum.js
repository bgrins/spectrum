...
var tinycolor=function(){function r(a){var b={r:255,g:255,b:255},c=!1;typeof a=="string"&&(a=s(a));if(typeof a=="object")if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))b={r:g(a.r,255)*255,g:g(a.g,255)*255,b:g(a.b,255)*255},c=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){var d=a.h;b=a.s;a=a.v;var f,i,h;d=g(d,360);b=g(b,100);a=g(a,100);c=Math.floor(d*6);var e=d*6-c;d=a*(1-b);var m=a*(1-e*b);b=a*(1-(1-e)*b);switch(c%6){case 0:f=a;i=b;h=d;break;
case 1:f=m;i=a;h=d;break;case 2:f=d;i=a;h=b;break;case 3:f=d;i=m;h=a;break;case 4:f=b;i=d;h=a;break;case 5:f=a,i=d,h=m}b={r:f*255,g:i*255,b:h*255};c=!0}else a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("l")&&(b=t(a.h,a.s,a.l),c=!0);return{ok:c,r:Math.min(255,Math.max(b.r,0)),g:Math.min(255,Math.max(b.g,0)),b:Math.min(255,Math.max(b.b,0))}}function p(a,b,c){a=g(a,255);b=g(b,255);c=g(c,255);var d=Math.max(a,b,c),f=Math.min(a,b,c),i,h=(d+f)/2;if(d==f)i=f=0;else{var e=d-f;f=h>0.5?e/
(2-d-f):e/(d+f);switch(d){case a:i=(b-c)/e+(b<c?6:0);break;case b:i=(c-a)/e+2;break;case c:i=(a-b)/e+4}i/=6}return{h:i,s:f,l:h}}function t(a,b,c){function d(a,b,c){c<0&&(c+=1);c>1&&(c-=1);if(c<1/6)return a+(b-a)*6*c;if(c<0.5)return b;if(c<2/3)return a+(b-a)*(2/3-c)*6;return a}a=g(a,360);b=g(b,100);c=g(c,100);if(b==0)c=b=a=c;else{var f=c<0.5?c*(1+b):c+b-c*b,e=2*c-f;c=d(e,f,a+1/3);b=d(e,f,a);a=d(e,f,a-1/3)}return{r:c*255,g:b*255,b:a*255}}function q(a,b,c){a=g(a,255);b=g(b,255);c=g(c,255);var d=Math.max(a,
b,c),f=Math.min(a,b,c),e,h=d-f;if(d==f)e=0;else{switch(d){case a:e=(b-c)/h+(b<c?6:0);break;case b:e=(c-a)/h+2;break;case c:e=(a-b)/h+4}e/=6}return{h:e,s:d==0?0:h/d,v:d}}function n(a,b,c){function d(a){return a.length==1?"0"+a:a}return[d(j(a).toString(16)),d(j(b).toString(16)),d(j(c).toString(16))].join("")}function g(a,b){var c=typeof a==="string"&&a.indexOf("%")!=-1;a=Math.min(b,Math.max(0,parseFloat(a)));c&&(a*=b/100);if(Math.abs(a-b)<1.0E-6)return 1;else if(a>1)return a%b/parseFloat(b);return a}
function l(a){return Math.min(1,Math.max(0,a))}function s(a){a=a.replace(u,"").replace(v,"").toLowerCase();o[a]&&(a=o[a]);if(a=="transparent")return{r:0,g:0,b:0,a:0};var b;if(b=k.rgb.exec(a))return{r:b[1],g:b[2],b:b[3]};if(b=k.hsl.exec(a))return{h:b[1],s:b[2],l:b[3]};if(b=k.hsv.exec(a))return{h:b[1],s:b[2],v:b[3]};if(b=k.hex6.exec(a))return{r:parseInt(b[1],16),g:parseInt(b[2],16),b:parseInt(b[3],16)};if(b=k.hex3.exec(a))return{r:parseInt(b[1]+""+b[1],16),g:parseInt(b[2]+""+b[2],16),b:parseInt(b[3]+
""+b[3],16)};return!1}var e=function(a){if(typeof a=="object"&&a.hasOwnProperty("_tc_id"))return a;a=r(a);var b=a.r,c=a.g,d=a.b;return{ok:a.ok,_tc_id:w++,toHsv:function(){return q(b,c,d)},toHsvString:function(){var a=q(b,c,d);return"hsv("+Math.round(a.h*360)+", "+Math.round(a.s*100)+"%, "+Math.round(a.v*100)+"%)"},toHsl:function(){return p(b,c,d)},toHslString:function(){var a=p(b,c,d);return"hsl("+Math.round(a.h*360)+", "+Math.round(a.s*100)+"%, "+Math.round(a.l*100)+"%)"},toHex:function(){return n(b,
c,d)},toHexString:function(){return"#"+n(b,c,d)},toRgb:function(){return{r:j(b),g:j(c),b:j(d)}},toRgbString:function(){return"rgb("+j(b)+", "+j(c)+", "+j(d)+")"},toName:function(){return x[n(b,d,c)]||!1}}};e.version="0.4";var u=/^[\s,#]+/,v=/\s+$/,w=0,j=Math.round;e.equals=function(a,b){return e(a).toHex()==e(b).toHex()};e.desaturate=function(a,b){var c=tinycolor(a).toHsl();c.s-=(b||10)/100;c.s=l(c.s);return tinycolor(c)};e.saturate=function(a,b){var c=tinycolor(a).toHsl();c.s+=(b||10)/100;c.s=l(c.s);
return tinycolor(c)};e.greyscale=function(a){return e.desaturate(a,100)};e.lighten=function(a,b){var c=tinycolor(a).toHsl();c.l+=(b||10)/100;c.l=l(c.l);return tinycolor(c)};e.darken=function(a,b){var c=tinycolor(a).toHsl();c.l-=(b||10)/100;c.l=l(c.l);return tinycolor(c)};e.triad=function(a){a=tinycolor(a).toRgb();return[tinycolor({r:a.r,g:a.g,b:a.b}),tinycolor({r:a.b,g:a.r,b:a.g}),tinycolor({r:a.g,g:a.b,b:a.r})]};e.tetrad=function(a){a=tinycolor(a).toRgb();return[tinycolor({r:a.r,g:a.g,b:a.b}),tinycolor({r:a.b,
g:a.r,b:a.g}),tinycolor({r:a.g,g:a.b,b:a.r}),tinycolor({r:a.r,g:a.b,b:a.r})]};e.monochromatic=function(a,b){b=b||6;for(var c=tinycolor(a).toHsv(),d=[];b--;)d.push(tinycolor(c)),c.v+=0.2,c.v%=1;return d};e.readable=function(a,b){var c=tinycolor(a).toRgb(),d=tinycolor(b).toRgb();return(d.r-c.r)*(d.r-c.r)+(d.g-c.g)*(d.g-c.g)+(d.b-c.b)*(d.b-c.b)>10404};var o=e.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"00ffff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000000",
...
yellowgreen:"9acd32"},x=function(a){var b={},c;for(c in a)a.hasOwnProperty(c)&&(b[a[c]]=c);return b}(o),k={rgb:RegExp("rgb[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),hsl:RegExp("hsl[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),hsv:RegExp("hsv[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),
hex3:/^([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex6:/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/};return e}();
