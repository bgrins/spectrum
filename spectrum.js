...
b,c),k=Math.min(a,b,c),f,h=d-k;if(d==k)f=0;else{switch(d){case a:f=(b-c)/h+(b<c?6:0);break;case b:f=(c-a)/h+2;break;case c:f=(a-b)/h+4}f/=6}return{h:f,s:d==0?0:h/d,v:d}}function o(a,b,c){function d(a){return a.length==1?"0"+a:a}return[d(i(a).toString(16)),d(i(b).toString(16)),d(i(c).toString(16))].join("")}function g(a,b){var c=typeof a==="string"&&a.indexOf("%")!=-1;a=Math.min(b,Math.max(0,parseFloat(a)));c&&(a*=b/100);if(Math.abs(a-b)<1.0E-6)return 1;else if(a>1)return a%b/parseFloat(b);return a}
function m(a){return Math.min(1,Math.max(0,a))}function t(a){a=a.replace(v,"").replace(w,"").toLowerCase();p[a]&&(a=p[a]);if(a=="transparent")return{r:0,g:0,b:0,a:0};var b;if(b=l.rgb.exec(a))return{r:b[1],g:b[2],b:b[3]};if(b=l.hsl.exec(a))return{h:b[1],s:b[2],l:b[3]};if(b=l.hsv.exec(a))return{h:b[1],s:b[2],v:b[3]};if(b=l.hex6.exec(a))return{r:parseInt(b[1],16),g:parseInt(b[2],16),b:parseInt(b[3],16)};if(b=l.hex3.exec(a))return{r:parseInt(b[1]+""+b[1],16),g:parseInt(b[2]+""+b[2],16),b:parseInt(b[3]+
""+b[3],16)};return!1}var d=function(a){if(typeof a=="object"&&a.hasOwnProperty("_tc_id"))return a;a=s(a);var b=a.r,c=a.g,d=a.b;return{ok:a.ok,_tc_id:x++,toHsv:function(){return r(b,c,d)},toHsvString:function(){var a=r(b,c,d);return"hsv("+Math.round(a.h*360)+", "+Math.round(a.s*100)+"%, "+Math.round(a.v*100)+"%)"},toHsl:function(){return q(b,c,d)},toHslString:function(){var a=q(b,c,d);return"hsl("+Math.round(a.h*360)+", "+Math.round(a.s*100)+"%, "+Math.round(a.l*100)+"%)"},toHex:function(){return o(b,
c,d)},toHexString:function(){return"#"+o(b,c,d)},toRgb:function(){return{r:i(b),g:i(c),b:i(d)}},toRgbString:function(){return"rgb("+i(b)+", "+i(c)+", "+i(d)+")"},toName:function(){return y[o(b,d,c)]||!1}}};d.version="0.4.1";var v=/^[\s,#]+/,w=/\s+$/,x=0,i=Math.round;d.equals=function(a,b){return d(a).toHex()==d(b).toHex()};d.desaturate=function(a,b){var c=d(a).toHsl();c.s-=(b||10)/100;c.s=m(c.s);return d(c)};d.saturate=function(a,b){var c=d(a).toHsl();c.s+=(b||10)/100;c.s=m(c.s);return d(c)};d.greyscale=
function(a){return d.desaturate(a,100)};d.lighten=function(a,b){var c=d(a).toHsl();c.l+=(b||10)/100;c.l=m(c.l);return d(c)};d.darken=function(a,b){var c=d(a).toHsl();c.l-=(b||10)/100;c.l=m(c.l);return d(c)};d.triad=function(a){return d.tetrad(a).slice(0,3)};d.tetrad=function(a){a=d(a).toRgb();return[d({r:a.r,g:a.g,b:a.b}),d({r:a.b,g:a.r,b:a.g}),d({r:a.g,g:a.b,b:a.r}),d({r:a.r,g:a.b,b:a.r})]};d.splitcomplement=function(a){var b=d(a).toHsv();return[d(a),d({h:(b.h+72)%360,s:b.s,v:b.v}),d({h:(b.h+216)%
360,s:b.s,v:b.v})]};d.analogous=function(a,b,c){b=b||6;c=c||30;var e=d(a).toHsv();c=360/c;a=[d(a)];for(e.h=(e.h-(c*b>>1)+720)%360;--b;)e.h=(e.h+c)%360,a.push(d(e));return a};d.monochromatic=function(a,b){b=b||6;for(var c=d(a).toHsv(),e=[];b--;)e.push(d(c)),c.v+=0.2,c.v%=1;return e};d.readable=function(a,b){var c=d(a).toRgb(),e=d(b).toRgb();return(e.r-c.r)*(e.r-c.r)+(e.g-c.g)*(e.g-c.g)+(e.b-c.b)*(e.b-c.b)>10404};var p=d.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",
...
tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},y=function(a){var b={},c;for(c in a)a.hasOwnProperty(c)&&(b[a[c]]=c);return b}(p),l={rgb:RegExp("rgb[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),hsl:RegExp("hsl[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),
