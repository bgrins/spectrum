...
var tinycolor=function(){function t(a){var b={r:255,g:255,b:255},c=!1;typeof a=="string"&&(a=u(a));if(typeof a=="object")if(a.hasOwnProperty("r")&&a.hasOwnProperty("g")&&a.hasOwnProperty("b"))b={r:h(a.r,255)*255,g:h(a.g,255)*255,b:h(a.b,255)*255},c=!0;else if(a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("v")){var f=a.h;b=a.s;a=a.v;var d,e,i;f=h(f,360);b=h(b,100);a=h(a,100);c=l.floor(f*6);var g=f*6-c;f=a*(1-b);var n=a*(1-g*b);b=a*(1-(1-g)*b);switch(c%6){case 0:d=a;e=b;i=f;break;case 1:d=
n;e=a;i=f;break;case 2:d=f;e=a;i=b;break;case 3:d=f;e=n;i=a;break;case 4:d=b;e=f;i=a;break;case 5:d=a,e=f,i=n}b={r:d*255,g:e*255,b:i*255};c=!0}else a.hasOwnProperty("h")&&a.hasOwnProperty("s")&&a.hasOwnProperty("l")&&(b=v(a.h,a.s,a.l),c=!0);return{ok:c,r:j(255,k(b.r,0)),g:j(255,k(b.g,0)),b:j(255,k(b.b,0))}}function r(a,b,c){a=h(a,255);b=h(b,255);c=h(c,255);var f=k(a,b,c),d=j(a,b,c),e,i=(f+d)/2;if(f==d)e=d=0;else{var g=f-d;d=i>0.5?g/(2-f-d):g/(f+d);switch(f){case a:e=(b-c)/g+(b<c?6:0);break;case b:e=
(c-a)/g+2;break;case c:e=(a-b)/g+4}e/=6}return{h:e*360,s:d*100,l:i*100}}function v(a,b,c){function d(a,b,c){c<0&&(c+=1);c>1&&(c-=1);if(c<1/6)return a+(b-a)*6*c;if(c<0.5)return b;if(c<2/3)return a+(b-a)*(2/3-c)*6;return a}a=h(a,360);b=h(b,100);c=h(c,100);if(b==0)c=b=a=c;else{var g=c<0.5?c*(1+b):c+b-c*b,e=2*c-g;c=d(e,g,a+1/3);b=d(e,g,a);a=d(e,g,a-1/3)}return{r:c*255,g:b*255,b:a*255}}function s(a,b,c){a=h(a,255);b=h(b,255);c=h(c,255);var d=k(a,b,c),g=j(a,b,c),e,i=d-g;if(d==g)e=0;else{switch(d){case a:e=
(b-c)/i+(b<c?6:0);break;case b:e=(c-a)/i+2;break;case c:e=(a-b)/i+4}e/=6}return{h:e*360,s:(d==0?0:i/d)*100,v:d*100}}function o(a,b,c){function d(a){return a.length==1?"0"+a:a}return[d(g(a).toString(16)),d(g(b).toString(16)),d(g(c).toString(16))].join("")}function h(a,b){typeof a=="string"&&a.indexOf(".")!=-1&&p(a)===1&&(a="100%");var c=typeof a==="string"&&a.indexOf("%")!=-1;a=j(b,k(0,p(a)));c&&(a*=b/100);if(l.abs(a-b)<1.0E-6)return 1;else if(a>=1)return a%b/p(b);return a}function u(a){a=a.replace(w,
"").replace(x,"").toLowerCase();q[a]&&(a=q[a]);if(a=="transparent")return{r:0,g:0,b:0,a:0};var b;if(b=m.rgb.exec(a))return{r:b[1],g:b[2],b:b[3]};if(b=m.hsl.exec(a))return{h:b[1],s:b[2],l:b[3]};if(b=m.hsv.exec(a))return{h:b[1],s:b[2],v:b[3]};if(b=m.hex6.exec(a))return{r:parseInt(b[1],16),g:parseInt(b[2],16),b:parseInt(b[3],16)};if(b=m.hex3.exec(a))return{r:parseInt(b[1]+""+b[1],16),g:parseInt(b[2]+""+b[2],16),b:parseInt(b[3]+""+b[3],16)};return!1}var d=function(a,b){if(typeof a=="object"&&a.hasOwnProperty("_tc_id"))return a;
if(typeof a=="object"&&(!b||!b.skipRatio))for(var c in a)a[c]===1&&(a[c]="1.0");c=t(a);var d=c.r,h=c.g,e=c.b;return{ok:c.ok,_tc_id:y++,toHsv:function(){return s(d,h,e)},toHsvString:function(){var a=s(d,h,e);return"hsv("+g(a.h)+", "+g(a.s)+"%, "+g(a.v)+"%)"},toHsl:function(){return r(d,h,e)},toHslString:function(){var a=r(d,h,e);return"hsl("+g(a.h)+", "+g(a.s)+"%, "+g(a.l)+"%)"},toHex:function(){return o(d,h,e)},toHexString:function(){return"#"+o(d,h,e)},toRgb:function(){return{r:g(d),g:g(h),b:g(e)}},
toRgbString:function(){return"rgb("+g(d)+", "+g(h)+", "+g(e)+")"},toName:function(){return z[o(d,e,h)]||!1}}};d.version="0.4.2";var w=/^[\s,#]+/,x=/\s+$/,y=0,l=Math,g=l.round,j=l.min,k=l.max,p=parseFloat;d.equals=function(a,b){return d(a).toHex()==d(b).toHex()};d.desaturate=function(a,b){var c=d(a).toHsl();c.s-=b||10;c.s=j(1,k(0,c.s/100));return d(c)};d.saturate=function(a,b){var c=d(a).toHsl();c.s+=b||10;c.s=j(1,k(0,c.s/100));return d(c)};d.greyscale=function(a){return d.desaturate(a,100)};d.lighten=
function(a,b){var c=d(a).toHsl();c.l+=b||10;c.l=j(1,k(0,c.l/100));return d(c)};d.darken=function(a,b){var c=d(a).toHsl();c.l-=b||10;c.l=j(1,k(0,c.l/100));return d(c)};d.triad=function(a){return d.tetrad(a).slice(0,3)};d.tetrad=function(a){a=d(a).toRgb();return[d({r:a.r,g:a.g,b:a.b}),d({r:a.b,g:a.r,b:a.g}),d({r:a.g,g:a.b,b:a.r}),d({r:a.r,g:a.b,b:a.r})]};d.splitcomplement=function(a){var b=d(a).toHsv();return[d(a),d({h:(b.h+72)%360,s:b.s,v:b.v}),d({h:(b.h+216)%360,s:b.s,v:b.v})]};d.analogous=function(a,
b,c){b=b||6;c=c||30;var f=d(a).toHsv();c=360/c;a=[d(a)];for(f.h=(f.h-(c*b>>1)+720)%360;--b;)f.h=(f.h+c)%360,a.push(d(f));return a};d.monochromatic=function(a,b){b=b||6;for(var c=d(a).toHsv(),f=[];b--;)f.push(d(c)),c.v+=0.2,c.v%=1;return f};d.readable=function(a,b){var c=d(a).toRgb(),f=d(b).toRgb();return(f.r-c.r)*(f.r-c.r)+(f.g-c.g)*(f.g-c.g)+(f.b-c.b)*(f.b-c.b)>10404};var q=d.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",
...
wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},z=function(a){var b={},c;for(c in a)a.hasOwnProperty(c)&&(b[a[c]]=c);return b}(q),m={rgb:RegExp("rgb[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),hsl:RegExp("hsl[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),
